...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_applications_sports" AS ENUM('Basketball', 'Soccer', 'Tennis', 'Swimming', 'Track & Field');
  CREATE TYPE "public"."enum_applications_gender" AS ENUM('Male', 'Female', 'Other', 'Prefer not to say');
  CREATE TYPE "public"."enum_applications_rising_grade" AS ENUM('G9', 'G10', 'G11', 'G12');
  CREATE TYPE "public"."enum_applications_financial_aid_interest" AS ENUM('Yes', 'No');
  CREATE TYPE "public"."enum_applications_status" AS ENUM('submitted', 'under_review', 'approved', 'rejected', 'waitlisted');
  ...
  CREATE TABLE "applications_sports" (
  	"order" integer NOT NULL,
  	"parent_id" integer NOT NULL,
  	"value" "enum_applications_sports",
  	"id" serial PRIMARY KEY NOT NULL
  );
  
  CREATE TABLE "applications" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"student_name_first" varchar NOT NULL,
  	"student_name_last" varchar NOT NULL,
  	"student_name_preferred_name" varchar,
  	"student_email" varchar NOT NULL,
  	"student_cell" varchar NOT NULL,
  	"birth_date" timestamp(3) with time zone NOT NULL,
  	"gender" "enum_applications_gender" NOT NULL,
  	"rising_grade" "enum_applications_rising_grade" NOT NULL,
  	...
  	"current_school_name" varchar NOT NULL,
  	"year_applying_for" varchar NOT NULL,
  	"financial_aid_interest" "enum_applications_financial_aid_interest" NOT NULL,
  	"transcript_id" integer,
  	"parent_name_first" varchar NOT NULL,
  	"parent_name_last" varchar NOT NULL,
  ...
  ALTER TABLE "applications_sports" ADD CONSTRAINT "applications_sports_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."applications"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "applications" ADD CONSTRAINT "applications_transcript_id_media_id_fk" FOREIGN KEY ("transcript_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "applications_sports_order_idx" ON "applications_sports" USING btree ("order");
  CREATE INDEX "applications_sports_parent_idx" ON "applications_sports" USING btree ("parent_id");
  CREATE UNIQUE INDEX "applications_student_email_idx" ON "applications" USING btree ("student_email");
  CREATE INDEX "applications_transcript_idx" ON "applications" USING btree ("transcript_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "applications_sports" CASCADE;
  ...
  DROP TYPE "public"."enum_applications_sports";
  DROP TYPE "public"."enum_applications_gender";
  DROP TYPE "public"."enum_applications_rising_grade";
  DROP TYPE "public"."enum_applications_financial_aid_interest";
